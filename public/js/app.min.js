...
(function()
{
    ...
    app.controller('AdminProductsController', ['$scope', '$filter', 'Notifications', 'Products', 'Categories', function($scope, $filter, Notifications, Products, Categories)
    {
        ...
        $scope.editProduct_categories = null;
        ...
        {
            console.log($scope.editProduct_expired_at);
            Products.edit($scope.editProduct_id, $scope.editProduct_name, $scope.editProduct_price, $scope.productImage, $scope.editProduct_expired_at, $scope.editProduct_quantity_min)
                .then(function()
                {
...
(function()
{
    ...
    app.service('Products', ['$q', '$http', '$httpParamSerializer', function($q, $http, $httpParamSerializer)
    {
        ...
        this.edit = function(id, name, price, image, expired_at, quantity_min)
        {
