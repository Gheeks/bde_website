    ...
    app.controller('HomeController', ['$scope', '$filter', 'Notifications', 'Products', 'Purchases', 'Categories', function($scope, $filter, Notifications, Products, Purchases, Categories)
    {
        ...
        $scope.validateCardSubmit = function(){
            ...
            .then(function(response){
                $('#validate').modal('hide');
                loadProducts();
                Notification.success('Encaissement enregistré !');
            })
            .catch(function(err){
                Notifications.error("Erreur lors de l'achat : " + err.message);
            })
        }
...
(function()
{
    ...
    app.controller('UsersController', ['$scope', 'Users', function($scope, Users)
    {
        ...
        $scope.scannedUser = {id: null};

        $scope.launchScan = function(){
            Users.launchScan().then(function(user){
                
            })
            .catch(function(){
                Notifications.error("Erreur lors du scan de la carte.");
            })
        }
