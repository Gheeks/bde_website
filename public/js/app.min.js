...
(function()
{
    ...
    app.controller('AdminProductsController', ['$scope', '$filter', 'Notifications', 'Products', function($scope, $filter, Notifications, Products)
    {
        // Current page
        ...
        {
            Products.add($scope.addProduct_name, $scope.addProduct_price, $scope.productImage, $scope.addProduct_expired_at, $scope.addProduct_quantity_min)
                .then(function()
                {
...
(function()
{
    ...
    app.service('Products', ['$q', '$http', '$httpParamSerializer', function($q, $http, $httpParamSerializer)
    {
        ...
        this.add = function(name, price, image, expired_at, quantity_min)
        {
            return $q(function(resolve, reject)
            {
                // Request
